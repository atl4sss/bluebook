...
const RW_QUESTIONS = [
  ...
  },
  {
    ...
    stem:
      "Herbivorous sauropod dinosaurs could grow more than 100 feet long and weigh up to 80 tons... however, there is no evidence of significant spikes in carbon dioxide coinciding with relevant periods in sauropod evolution, suggesting that ______",
    choices: [
  ...
  },
  {
    ...
    stem:
      "While researching a topic, a student has taken the following notes: The Philadelphia and Lancaster Turnpike was a road built between 1792 and 1794; It was the first private turnpike in the United States; It was sixty-two miles long.",
    choices: [
  ...
  },
  {
    ...
    stem:
      "While researching a topic, a student has taken the following notes: 7 sea turtle species; 5 in Atlantic; Kemp’s ridley (Lepidochelys kempii); olive ridley (Lepidochelys olivacea).",
    choices: [
  ...
  },
  {
    ...
    stem:
      "While researching a topic, a student has taken the following notes: Angana Chaudhuri is a scientist.; Chaudhuri studies sedimentary rocks ; A scientist who studies sedimentary rocks is called a sedimentologist; Shale, chalk, and sandstone are examples of sedimentary rocks. ",
    choices: [
  ...
  },
  {
    ...
    stem:
      "While researching a topic, a student has taken the following notes: Chiura Obata was a Japanese American artist who lived in California; Yosemite Falls is a notable painting by Obata. ; It uses a Japanese method of black ink painting called sumi-e.; This painting was completed in 1930.",
    choices: [
  ...
  },
  {
    ...
    stem:
      "While researching a topic, a student has taken the following notes: Earthquakes start at a focus → seismic waves. Two subsurface wave types: P and S. P faster; P compress/expand ground; S move side to side.",
    choices: [
...
const RW_QUESTIONS_2 = [
  ...
  },
  {
    prompt: "Which choice completes the text with the most logical and precise word or phrase?",
    stem:
      "Barring major archaeological discoveries, we are unlikely to ever have ______blank account of ancient Egypt under the female pharaoh Hatshepsut, as much of the evidence of her reign was deliberately destroyed by her successors.",
  ...
  {
    prompt: "Which quotation from “To You” most effectively illustrates the claim?",
    stem:
  ...
  },
  {
    ...
    choices: ["bounds helped", "bounds, helping", "bounds that helped", "bounds to help"],
  },
  {
    prompt: "Which choice completes the text so that it conforms to the conventions of Standard English?",
    stem:
    ...
    choices: ["biologist, Yuree Lee", "biologist Yuree Lee,", "biologist Yuree Lee", "biologist, Yuree Lee,"],
  },
  {
    prompt: "Which choice completes the text so that it conforms to the conventions of Standard English?",
    stem:
    ...
    choices: ["are highly prized", "had been highly prized", "highly prized", "were highly prized"],
  },
  {
    prompt: "Which choice completes the text so that it conforms to the conventions of Standard English?",
    stem:
    ...
    choices: ["antiquity, however", "antiquity, however,", "antiquity, however;", "antiquity; however,"],
  },
  {
    prompt: "Which choice most logically completes the text?",
    stem:
  ...
  },
  {
    prompt: "Which choice completes the text with the most logical transition?",
    stem:
      "With his room-sized installation Unicorn/My Private Sky, Norwegian artist Børre Sæthre succeeds in creating a whimsical yet perplexing experience. ______blank when visitors set foot inside the fantastically blue room and encounter the life-sized stuffed unicorn preening at the far end of it, they are both dazzled and confused—as if stepping into a strange and enchanting new world.",
...
const MATH_QUESTIONS = [
  {
    stem:
      "A veterinarian recommends that each day a certain rabbit should eat 25 calories per pound of the rabbit’s weight, plus an additional 11 calories. Which equation represents this situation, where c is the total number of calories the rabbit should eat each day if the rabbit’s weight is x pounds?",
  ...
  {
    stem:
      "The function f(x) = 14 + 4x represents the total cost, in dollars, of attending an arcade when x games are played. How many games can be played for a total cost of 58 dollars?",
    grid: true,
  },
  {
  ...
  {
    stem:
      "The amount of Hanna's bill for a food order was 50 dollars. Hanna gave a tip of 20% of the amount of the bill. What is the amount, in dollars, of the tip Hanna gave?",
    grid: true,
  },
  {
    stem:
  ...
  {
    stem:
      "The length of each edge of a box is 29 inches. Each side of the box is a square. The box does not have a lid. What is the exterior surface area, in square inches, of this box without a lid?",
    grid: true,
  },
  {
  ...
  {
    stem:
      "A right rectangular prism has a height of 9 inches. The length of the prism's base is x inches, which is 7 inches more than the width of the prism's base. Which function V gives the volume of the prism, in cubic inches, in terms of the length x of the prism's base?",
    choices: [
      "V(x) = x(x + 9)(x + 7)",
      "V(x) = x(x + 9)(x − 7)",
      "V(x) = 9x(x + 7)",
  ...
  {
    stem:
      "The equation x + y = 1440 represents the number of minutes of daylight (between sunrise and sunset), x, and the number of minutes of non-daylight, y, on a particular day in Oak Park, Illinois. If this day has 670 minutes of daylight, how many minutes of non-daylight does it have?",
...
const MATH_QUESTIONS_2 = [
  {
    stem:
      "The function g is defined by g(x) = |2x - 5| - 3. For which value of x is g(x) = 0?",
    choices: ["1", "2", "4", "5"],
  },
  {
    stem:
      "Solve for x: 5x² − 13x + 6 = 0. Enter the larger solution.",
    grid: true,
  },
  {
    stem:
      "The quadratic function f(x) = ax² + bx + c has zeros at x = -2 and x = 5 and passes through the point (1, -12). What is the value of a?",
    choices: ["-1", "-2", "1", "2"],
  },
  {
    stem:
      "A line passes through the points (2, 7) and (8, -5). Enter the slope of the line.",
    grid: true,
  },
  {
    stem:
      "The line with equation y = -3x + 10 is reflected across the x-axis. What is the equation of the image line?",
    choices: [
      "y = 3x + 10",
      "y = -3x - 10",
      "y = 3x - 10",
  ...
  {
    stem:
      "A data set has five numbers. Four of the numbers are 6, 9, 9, and 10. The mean of all five numbers is 11. Enter the missing number.",
    grid: true,
  },
  {
    stem:
      "A circle has center (4, -1) and radius 5. Which of the following points lies on the circle?",
    choices: ["(4, 4)", "(9, -1)", "(0, -4)", "(8, 3)"],
  },
  {
    stem:
      "The sum of three consecutive integers is 111. Enter the largest of the three integers.",
    grid: true,
  },
  {
    stem:
      "The average (arithmetic mean) of five numbers is 18. When one number is removed, the average of the remaining four numbers is 16. What number was removed?",
    choices: ["10", "14", "18", "26"],
  },
  {
    stem:
      "A savings account has an initial balance of 500 dollars and grows by 4% each year, compounded annually. Which expression gives the balance, in dollars, after t years?",
    choices: [
      "500 + 0.04t",
      "500(1.04)ᵗ",
      "500(0.96)ᵗ",
  ...
  {
    stem:
      "The inequality 4(2x − 3) + 5 ≤ 3(x + 1) is equivalent to which of the following?",
    choices: ["x ≤ -1", "x ≥ -1", "x ≤ 17", "x ≥ 17"],
  },
  {
    stem:
      "In a right triangle, one acute angle measures 35°. What is the measure, in degrees, of the other acute angle?",
    grid: true,
  },
  {
    stem:
      "The system of equations 3x + ky = 12 and 2x - 4y = 8 has no solution. What is the value of k?",
    choices: ["-6", "-3", "3", "6"],
  },
  {
    stem:
      "A bag contains 5 red, 7 blue, and 8 green marbles. One marble is chosen at random. What is the probability that the marble is not blue?",
  ...
  {
    stem:
      "For x > 0, the function p(x) = x + 16/x has a minimum value at some x. Enter that value of x.",
    grid: true,
  },
  {
    stem:
      "The line y = -3x + 10 is reflected across the x-axis. What is the equation of the image line?",
    choices: [
      "y = 3x + 10",
      "y = -3x - 10",
      "y = 3x - 10",
  ...
  {
    stem:
      "A cylindrical tank has radius 4 meters and height 6 meters. What is its volume, in cubic meters, in terms of π? (Use the form aπ.)",
    grid: true,
  },
  {
    stem:
      "The solutions to the equation x² - 8x + k = 0 are 4 ± √7. What is the value of k?",
    choices: ["7", "9", "16", "23"],
  },
  {
    stem:
      "The function h is defined by h(x) = 3(2ˣ) − 5. What is the value of x such that h(x) = 19?",
    choices: ["1", "2", "3", "4"],
  },
  {
    stem:
      "The function f is defined by f(x) = 2x² − 5x + 1. What is the value of f(3)?",
    grid: true,
  },
  {
    stem:
      "A rectangle has length 3x + 4 and width x − 1. Its area is 44 square units. What is the value of x?",
    choices: ["3", "4", "5", "6"],
  },
];
...
const STAGES = [
  ...
  { sec: 1, mod: 2, title: "Reading and Writing", mins: 32, qs: RW_QUESTIONS_2 },
  { id: "break", mins: 10 },
...
export default function TestPage() {
  ...
  if (stage.id === "break")
    return <BreakScreen sec={secLeft} fmt={fmt} onResume={() => nextStage()} takerName={takerName}/>;
...
/* ---------------- Break Screen ---------------- */
function BreakScreen({ sec, fmt, onResume, takerName }) {
  return (
    <div className="min-h-screen flex flex-col bg-[#111] text-white font-sans">
      ...
      <div className="flex-1 grid md:grid-cols-2 place-items-center px-6 py-10 gap-12">
        ...
        <div className="max-w-md text-[15px] leading-6">
          ...
          <p className="mb-6">
            After the break,{" "}
            <span onClick={onResume} className="font-semibold cursor-pointer">
              Resume Testing Now
            </span>{" "}
      ...
      {/* имя — строго слева снизу как на рефе */}
      {takerName && (
        <span
          className="
            absolute left-10 bottom-8
            text-white text-[18px] md:text-[20px] font-medium
            select-none
          "
        >
          {takerName}
